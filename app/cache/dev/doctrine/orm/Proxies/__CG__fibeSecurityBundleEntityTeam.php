...
namespace Proxies\__CG__\fibe\SecurityBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Team extends \fibe\SecurityBundle\Entity\Team implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'fibe\\SecurityBundle\\Entity\\Team' . "\0" . 'id', '' . "\0" . 'fibe\\SecurityBundle\\Entity\\Team' . "\0" . 'conference', '' . "\0" . 'fibe\\SecurityBundle\\Entity\\Team' . "\0" . 'confManagers');
        }
