 ...
 */
class Topic extends \fibe\Bundle\WWWConfBundle\Entity\Topic implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'label', '' . "\0" . 'fibe\\Bundle\\WWWConfBundle\\Entity\\Topic' . "\0" . 'papers', '' . "\0" . 'fibe\\Bundle\\WWWConfBundle\\Entity\\Topic' . "\0" . 'events', 'mainEvent', 'slug');
        }
