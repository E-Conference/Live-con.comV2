...
class LoginTest extends WebTestCase
{
  ...
  /**
   * test command livecon:admin:create admin2 admin2@admin.fr admin2
   */
  public function testCreateUser()
  {
    $output = $this->runCommand($this->client, "livecon:admin:create ".$this->user["username"]." ".$this->user["email"]." ".$this->user["password"]);
