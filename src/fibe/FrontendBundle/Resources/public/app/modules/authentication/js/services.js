...
angular.module('authenticationApp').factory('globalHttpInterceptor', ['$q', '$http','tokenHandler',
...
angular.module('authenticationApp').factory('Base64', ['ngCookies', 'ngResource', function() {
...
angular.module('authenticationApp').factory('TokenHandler', [ '$http', '$cookieStore', 'Base64', function($http, $cookieStore, Base64) {
    var tokenHandler = {};
    var token = 'none';
