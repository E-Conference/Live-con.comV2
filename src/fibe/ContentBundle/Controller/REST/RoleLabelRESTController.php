...
class RoleLabelRESTController extends FOSRestController
{
     ...
     * @Rest\Get("/mainEvents/{confId}/roleLabels", name="content_roleLabels_all_by_conference")
     * @Rest\View
     ...
     */
    public function getRoleLabelsByConferenceAction(Request $request, ParamFetcherInterface $paramFetcher, $confId)
    {
