...
//    }
    ...
    /**
     * Displays a form to edit an existing VEvent entity.
     *
     * @Route("/{id}/edit", name="vevent_edit")
     * @Method("GET")
     * @Template()
     */
...
//    }
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('vevent_edit', array('id' => $id)));
        }
    ...
    /**
     * Deletes a VEvent entity.
     *
     * @Route("/{id}", name="vevent_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('vevent'));
    }

    /**
     * Creates a form to delete a VEvent entity by id.
     *
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('vevent_delete', array('id' => $id)))
            ->setMethod('DELETE')
