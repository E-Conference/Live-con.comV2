...
class CategoryRESTController extends FOSRestController
{
     ...
     * @Rest\Get("/mainEvents/{confId}/categories", name="schedule_categories_all_by_conference")
     * @Rest\View
     ...
     */
    public function getCategoriesByConferenceAction(Request $request, ParamFetcherInterface $paramFetcher, $confId)
    {
